...
class ConstantsShouldBeStaticFinalCheckSample {
  ...
  abstract class A extends Parent {
    ...
    public final int f4 = ConstantsShouldBeStaticFinalCheckSampleEnumTest.MY_CONSTANT; // Noncompliant
    ...
    private final checks.ConstantsShouldBeStaticFinalCheckSample.A myA = this; // Compliant
    private final int
      f10 = 0,                                             // Noncompliant
      f11,                                                 // Compliant
      f12 = foo(),                                         // Compliant
...
enum ConstantsShouldBeStaticFinalCheckSampleEnumTest {
  TEST1(4);
  final static int MY_CONSTANT = 1;
  private final int possible;
  private ConstantsShouldBeStaticFinalCheckSampleEnumTest(int test) {
    possible = test;
  }
}

class ConstantsShouldBeStaticFinalCheckSampleDemo {
